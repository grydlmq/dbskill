...
[![Version](https://img.shields.io/badge/version-2.18.0-2563EB.svg?style=flat-square)](VERSION)
...
本次更新（v2.18.0）：`dbs-knowledge` 新增知识库导航瘦身与分层治理，可审计膨胀的 SOT，将明细下沉到局部索引，并在优化后验证路径与权威事实。
